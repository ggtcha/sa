...
function T02() {
    return (
        ...
        <div className="project-image">
            <img src="https://www.royalhouse.co.th/wp-content/uploads/2021/08/RH-TP.20631.jpg" alt="รูปโปรเจค" />
        </div>
        ...
        <div className="details-container">
            ...
            <div className="image-right">
                <img src="https://www.royalhouse.co.th/wp-content/uploads/2021/08/RH-TP.2063-1.jpg" alt="ภาพเสริม" className="small-image" />
            </div>
        </div>
