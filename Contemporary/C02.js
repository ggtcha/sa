...
function C02() {
    return (
        ...
        <div className="project-image">
            <img src="https://www.royalhouse.co.th/wp-content/uploads/2024/10/RH-CT.702-1024x683.jpg" alt="รูปโปรเจค" />
        </div>
        ...
        <div className="details-container">
            ...
            <div className="image-right">
                <img src="https://www.royalhouse.co.th/wp-content/uploads/2024/10/RH-CT.702-plan.jpg" alt="ภาพเสริม" className="small-image" />
            </div>
        </div>
