    ...
    return (
        <div className="container-fluid vh-100"> 
            ...
            <div className="row h-40 mt-4">
                ...
                <div className="col-md-4 d-flex align-items-center" style={{ paddingLeft: '100px' }}>
                    <div className="card hover-card" style={{ width: '100%' }}>
                        <img src="https://www.mydomaine.com/thmb/M5TqcQoKjRhQjzG9A9lpz-pniOA=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/ScandinavianHome-45791b0e994e49909769e1fb8ce13400.jpg" className="card-img-top" alt="Scandinavian style house" style={{ width: '100%', height: '250px', objectFit: 'cover' }} />
                        <div className="card-body">
                            <h5 className="card-title">Scandinavian Style</h5>
                            <p className="card-text">บ้านที่เน้นความเรียบง่ายและความอบอุ่น ใช้วัสดุธรรมชาติเช่นไม้และโทนสีอ่อน</p>
                            <a href="/scandinavian" className="btn btn-primary">View details</a>
                        </div>
                    </div>
                </div>
